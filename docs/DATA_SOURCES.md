...
The project raster contains approximately 11.48 million people when finite cell values are summed. The project workflow used a normalised statewide population total of 11.61 million; 11.60 million people were successfully assigned to LGAs, representing 99.92% of the analysis total.
